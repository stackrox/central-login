...
async function run(): Promise<void> {
    try {
        ...
        core.info(
            `Attempting to obtain an access token for Central ${endpoint}...`
        )
        ...
        core.info('Successfully set the variable ROX_API_TOKEN and ROX_ENDPOINT to the access token and ' +
